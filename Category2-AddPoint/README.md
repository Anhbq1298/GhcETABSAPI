...
- `GhcSetPointInfo.cs` – Diff an Excel sheet (UniqueName/X/Y/Z) against a captured baseline tree, highlight edits, and push renames/coordinate updates back to ETABS by selecting points and driving `EditGeneral.Move`.
