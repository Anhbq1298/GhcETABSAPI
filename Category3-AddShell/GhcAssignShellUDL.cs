// -------------------------------------------------------------
// Component : Assign Shell Uniform Load (AreaObj.SetLoadUniform)
...
{
    public class GhcAssignShellUDL : GH_Component
    {
        ...
        public GhcAssignShellUDL()
          : base(
                "Assign Shell Uniform Load",
                "ShellUDL",
        ...
        protected override void SolveInstance(IGH_DataAccess da)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < shellNames.Count; i++)
                {
                    ...
                    double? maybeValue = ComponentShared.TryGet(values, i);
                    ...
                    if (ComponentShared.IsInvalidNumber(value))
                    {
